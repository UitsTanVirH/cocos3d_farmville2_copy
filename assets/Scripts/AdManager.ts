...
declare global {
  interface Window {
    mraid?: {
      addEventListener: (
        event: string,
        callback: (data?: any, data2?: any, data3?: any[]) => void,
      ) => void;
      removeEventListener?: (
        event: string,
...
export class GenericAdAdapter implements AdAdapter {
  ...
  SetUpGlobalMethods(): void {
    if (!window.adManOpenStore) {
      window.adManOpenStore = (url?: string) => {
        console.log(
          "[GenericAdapter] window.adManOpenStore() called! Delegating to window.open()",
        );
  ...
  OpenStore(url?: string) {
    ...
    if (window.adManOpenStore) {
      console.log(
        "[GenericAdapter] OpenStore() called! Delegating to window.adManOpenStore()",
      );
  ...
  GameReady(): void {
    if (window.adManGameReady) {
      console.log(
        "[GenericAdapter] GameReady() called! Delegating to window.adManGameReady()",
      );
  ...
  GameEnd(): void {
    if (window.adManGameEnd) {
      console.log(
        "[GenericAdapter] GameEnd() called! Delegating to window.adManGameEnd()",
      );
  ...
  GameRetry(): void {
    if (window.adManGameRetry) {
      console.log(
        "[GenericAdapter] GameRetry() called! Delegating to window.adManGameRetry()",
      );
...
export class MRAIDAdAdapter implements AdAdapter {
  ...
  SetUpGlobalMethods(): void {
    if (!window.adManOpenStore) {
      window.adManOpenStore = (url?: string) => {
        console.log(
          "[MRAIDAdapter] window.adManOpenStore() called! Delegating to window.mraid.open()",
        );
  ...
  HookEvents(): void {
    ...
    window.mraid.addEventListener("error", (msg: string) =>
      AdManager.emit(AdEvent.ERROR, msg),
    );
    ...
    window.mraid.addEventListener(
      "exposureChange",
      (percentage: number, visibleRect: any, occlusionRectangles: any[]) => {
        AdManager.emit(
          AdEvent.VIEWABLE_CHANGE,
          percentage,
          visibleRect,
          occlusionRectangles,
        );
    ...
    window.mraid.addEventListener(
      ...
      (vol_percentage: number) =>
        AdManager.emit(AdEvent.AUDIO_CHANGE, vol_percentage),
    );
  }
  ...
  OpenStore(url?: string) {
    ...
    if (window.adManOpenStore) {
      console.log(
        "[MRAIDAdapter] OpenStore() called! Delegating to window.adManOpenStore()",
      );
  ...
  GameReady(): void {
    if (window.adManGameReady) {
      console.log(
        "[MRAIDAdapter] GameReady() called! Delegating to window.adManGameReady()",
      );
  ...
  GameEnd(): void {
    if (window.adManGameEnd) {
      console.log(
        "[MRAIDAdapter] GameEnd() called! Delegating to window.adManGameEnd()",
      );
  ...
  GameRetry(): void {
    if (window.adManGameRetry) {
      console.log(
        "[MRAIDAdapter] GameRetry() called! Delegating to window.adManGameRetry()",
      );
...
export class MetaAdAdapter implements AdAdapter {
  ...
  SetUpGlobalMethods(): void {
    if (!window.adManOpenStore) {
      window.adManOpenStore = (url?: string) => {
        console.log(
          "[MetaAdapter] window.adManOpenStore() called! Delegating to window.FbPlayableAd.onCTAClick()",
        );
  ...
  HookEvents(): void {
    ...
    window.FbPlayableAd.onError?.((e: string) =>
      AdManager.emit(AdEvent.ERROR, e),
    );
  }
  ...
  OpenStore(url?: string) {
    ...
    if (window.adManOpenStore) {
      console.log(
        "[MetaAdapter] OpenStore() called! Delegating to window.adManOpenStore()",
      );
  ...
  GameReady(): void {
    if (window.adManGameReady) {
      console.log(
        "[MetaAdapter] GameReady() called! Delegating to window.adManGameReady()",
      );
  ...
  GameEnd(): void {
    if (window.adManGameEnd) {
      console.log(
        "[MetaAdapter] GameEnd() called! Delegating to window.adManGameEnd()",
      );
  ...
  GameRetry(): void {
    if (window.adManGameRetry) {
      console.log(
        "[MetaAdapter] GameRetry() called! Delegating to window.adManGameRetry()",
      );
...
export class MintegralAdAdapter implements AdAdapter {
  ...
  SetUpGlobalMethods(): void {
    if (!window.adManOpenStore) {
      window.adManOpenStore = (url?: string) => {
        console.log(
          "[MintegralAdapter] window.adManOpenStore() called! Delegating to window.install()",
        );
    ...
    if (!window.adManGameReady) {
      window.adManGameReady = () => {
        console.log(
          "[MintegralAdapter] window.adManGameReady() called! Delegating to window.gameReady()",
        );
    ...
    if (!window.adManGameEnd) {
      window.adManGameEnd = () => {
        console.log(
          "[MintegralAdapter] window.adManGameEnd() called! Delegating to window.gameEnd()",
        );
    ...
    if (!window.adManGameRetry) {
      window.adManGameRetry = () => {
        console.log(
          "[MintegralAdapter] window.adManGameRetry() called! Delegating to window.gameRetry()",
        );
  ...
  OpenStore(url?: string) {
    ...
    if (window.adManOpenStore) {
      console.log(
        "[MintegralAdapter] OpenStore() called! Delegating to window.adManOpenStore()",
      );
  ...
  GameReady(): void {
    if (window.adManGameReady) {
      console.log(
        "[MintegralAdapter] GameReady() called! Delegating to window.adManGameReady()",
      );
  ...
  GameEnd(): void {
    if (window.adManGameEnd) {
      console.log(
        "[MintegralAdapter] GameEnd() called! Delegating to window.adManGameEnd()",
      );
  ...
  GameRetry(): void {
    if (window.adManGameRetry) {
      console.log(
        "[MintegralAdapter] GameRetry() called! Delegating to window.adManGameRetry()",
      );
...
export class AdManager {
  ...
  constructor() {
    if (window.mraid) AdManager.s_adAdapter = new MRAIDAdAdapter();
      ...
      AdManager.s_adAdapter = new MintegralAdAdapter();
