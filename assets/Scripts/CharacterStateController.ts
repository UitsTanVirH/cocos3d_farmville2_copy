import { _decorator, animation, CharacterController, Component, Node } from 'cc';
...
export class CharacterStateController extends Component 
{
    ...
    start() 
    {
        ...
        this.m_stateManager = new StateManager<CharacterStateContext>(this.m_characterStateContext, (e) => 
        {
    ...
    update(deltaTime: number) 
    {
        ...
        if(this.m_stateManager.GetCurrentStateName() !== CharacterState.RUN && (velLength > 0))
        {
            this.m_stateManager.ChangeState(CharacterState.RUN);
        }
        else if(this.m_stateManager.GetCurrentStateName() !== CharacterState.IDLE && velLength === 0)
        {
            this.m_stateManager.ChangeState(CharacterState.IDLE);
        }
    }
